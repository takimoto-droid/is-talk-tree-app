...
export default function TalkScriptPanel({ companyName, industry, news, bestCase, secondCase }: TalkScriptPanelProps) {
...
DOMO株式会社の○○と申します。`,
    ...
    },
    {
      step: 3,
      title: 'DOMOの紹介',
      content: `DOMOは、アメリカのユタ州に本社がございまして、データ活用のクラウドプラットフォームを提供しております。

Fortune 500企業の半数以上、日本でも${industry}を中心に多くの企業様にご導入いただいております。`,
      tip: 'アメリカ発のグローバル企業であることを伝える',
    },
    {
      step: 4,
      title: '記事の特徴を要約',
...
また、「${secondNews.title}」という記事からも、データを活用した意思決定の重要性を認識されていると感じております。` : ''}`
    ...
    },
    {
      step: 5,
      title: '類似企業を名乗る',
      content: `弊社、丁度直近で${industry}の「${bestCase.companyName}」様、「${secondCase.companyName}」様にご導入いただいております。`,
